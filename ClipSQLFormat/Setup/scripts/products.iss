...
pt.depdownload_msg=É necessário instalar os seguintes aplicativos antes de continuar:%n%n%1%nDeseja baixar e instalar agora?
pt.depdownload_memo_title=Baixar dependencias
pt.depinstall_memo_title=Instalar dependencias
pt.depinstall_title=Instalando dependencias
pt.depinstall_description=Por favor, aguarde até enquanto o Setup instala as dependências no seu computador.
pt.depinstall_status=Instalando %1...
pt.depinstall_missing=%1 deve ser instalado antes da instalação continuar. Por favor, instale %1 e execute a instalação novamente.
pt.depinstall_error=Ocorreu um erro enquanto as dependências eram instaladas. Por favor, reinicie o seu computador e execute o instalador novamente ou instale as seguintes dependências manualmente:%n
pt.isxdl_langfile=portuguese.ini


[Files]
Source: scripts\isxdl\portuguese.ini; Flags: dontcopy
...
var
  ...
  TimePage: TInputQueryWizardPage;
